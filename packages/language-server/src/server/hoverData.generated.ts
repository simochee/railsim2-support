...
export const objectDocs: Record<string, ObjectDoc> = {
  "RailInfo": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_rail.html",
    "helpTitle": "レールプラグイン",
    "properties": {
      "Gauge": {
  ...
  "TieInfo": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_tie.html",
    "helpTitle": "枕木プラグイン",
    "properties": {
      "Height": {
  ...
  "GirderInfo": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_girder.html",
    "helpTitle": "橋桁プラグイン",
    "properties": {
      "Height": {
  ...
  "PierInfo": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_pier.html",
    "helpTitle": "橋脚プラグイン",
    "properties": {
      "TrackNum": {
  ...
  "LineInfo": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_line.html",
    "helpTitle": "架線プラグイン",
    "properties": {
      "TrolleyAlt": {
  ...
  "PoleInfo": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_pole.html",
    "helpTitle": "架線柱プラグイン",
    "properties": {
      "TrackNum": {
  ...
  "TrainInfo": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_train.html",
    "helpTitle": "車輌プラグイン",
    "properties": {
      "FrontLimit": {
  ...
  "StationInfo": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_station.html",
    "helpTitle": "駅舎プラグイン",
    "properties": {}
  },
  "StructInfo": {
    "description": "施設プラグインは、その他の建物、構造物などを表現するために使用されます。",
    "helpUrl": "https://rs2.simochee.net/pi_struct.html",
    "helpTitle": "施設プラグイン",
    "properties": {}
  },
  "SurfaceInfo": {
    "description": "地形プラグインは、レイアウトの土台となる地形を表現するために使用されます。",
    "helpUrl": "https://rs2.simochee.net/pi_surface.html",
    "helpTitle": "地形プラグイン",
    "properties": {
      "SizeX": {
  ...
  "EnvInfo": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_env.html",
    "helpTitle": "環境プラグイン",
    "properties": {
      "Latitude": {
  ...
  "Profile": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_profile.html",
    "helpTitle": "プロファイルプラグイン",
    "properties": {}
  },
  "DefineAnimation": {
    "description": "1 枚の画像からなるアニメーションの単一フレームを定義します。",
    "helpUrl": "https://rs2.simochee.net/pi_sym_animation_frame.html",
    "helpTitle": "animation-frame",
    "properties": {
      "Frame": {
      ...
      "\"img%d.png\"": {
        ...
        "helpUrl": "https://rs2.simochee.net/pi_sym_animation_numbered_frame.html",
        "helpTitle": "animation-numbered-frame"
      },
      "\"img%3d.png\"": {
      ...
      "ChangeTexture": {
        ...
        "helpUrl": "https://rs2.simochee.net/pi_sym_animation_texture_transformer.html",
        "helpTitle": "animation-texture-transformer"
      },
      "ScaleTexture": {
  ...
  "Axle": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_axle_object.html",
    "helpTitle": "axle-object",
    "properties": {
      "Axle": {
      ...
      "ChangeAlpha": {
        ...
        "helpUrl": "https://rs2.simochee.net/pi_sym_alpha_changer.html",
        "helpTitle": "alpha-changer"
      },
      "AlphaZeroTest": {
        "description": "αテストを設定する材質番号を指定します。指定された材質は、テクスチャのα値が 0 であると描画されません。",
        "helpUrl": "https://rs2.simochee.net/pi_sym_alpha_tester.html",
        "helpTitle": "alpha-tester"
      },
      "SetAnimation": {
        "description": "アニメーションを適用する材質番号と、texture-animation で定義したアニメーション名を指定します。",
        "helpUrl": "https://rs2.simochee.net/pi_sym_animation_applier.html",
        "helpTitle": "animation-applier"
      },
      "EnvMap": {
        "description": "環境マップを設定する材質番号を指定します。環境マップは周囲の反射を擬似的に表現するもので、ステンレスなど光沢のある材質を表現するのに使います。環境マップのテクスチャは環境プラグインで指定されたものになります。",
        "helpUrl": "https://rs2.simochee.net/pi_sym_env_mapper.html",
        "helpTitle": "env-mapper"
      },
      "ChangeModel": {
        "description": "差し替える *.x ファイル、差し替え後のスケールを設定します。",
        "helpUrl": "https://rs2.simochee.net/pi_sym_model_changer.html",
        "helpTitle": "model-changer"
      },
      "ModelFileName": {
        "description": "オブジェクトの *.x ファイルを指定します。",
        "helpUrl": "https://rs2.simochee.net/pi_sym_named_object_info.html",
        "helpTitle": "named-object-info"
      },
      "ModelScale": {
      ...
      "NoCastShadow": {
        ...
        "helpUrl": "https://rs2.simochee.net/pi_sym_shadow_inhibitor.html",
        "helpTitle": "shadow-inhibitor"
      },
      "NoReceiveShadow": {
      ...
      "ChangeTexture": {
        "description": "テクスチャを変更する材質番号と、変更後のテクスチャファイルを指定します。",
        "helpUrl": "https://rs2.simochee.net/pi_sym_texture_changer.html",
        "helpTitle": "texture-changer"
      },
      "ScaleTexture": {
        "description": "UV 座標をスケーリングした後で平行移動します。材質番号に続けて、u, v 方向の倍率、移動する u, v 値の順に指定します。",
        "helpUrl": "https://rs2.simochee.net/pi_sym_texture_transformer.html",
        "helpTitle": "texture-transformer"
      },
      "RotateTexture": {
        "description": "UV 座標を指定座標を中心に回転します。材質番号に続けて、反時計回りの回転角度 [deg]、中心 u, v 座標の順に指定します。",
        "helpUrl": "https://rs2.simochee.net/pi_sym_texture_transformer.html",
        "helpTitle": "texture-transformer"
      },
      "TransformTexture": {
        "description": "UV 座標に対する一般の 2D アフィン変換です。材質番号に続けて、パラメータ a11, a12, a13, a21, a22, a23 の順に指定します。変換式を以下に示します。",
        "helpUrl": "https://rs2.simochee.net/pi_sym_texture_transformer.html",
        "helpTitle": "texture-transformer"
      }
    }
  ...
  "Body": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_body_object.html",
    "helpTitle": "body-object",
    "properties": {
      "Body": {
  ...
  "Tilt": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_body_tilt_info.html",
    "helpTitle": "body-tilt-info",
    "properties": {
      "TiltRatio": {
  ...
  "Slide": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_crank_slide_zy.html",
    "helpTitle": "crank-slide-zy",
    "properties": {
      "Slide": {
  ...
  "ApplySwitch": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_customizer_switch_applier.html",
    "helpTitle": "customizer-switch-applier",
    "properties": {
      "ApplySwitch": {
  ...
  "DynamicRotation": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_dynamic_rotator.html",
    "helpTitle": "dynamic-rotator",
    "properties": {
      "RotationAxis": {
  ...
  "Landscape": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_env_landscape_info.html",
    "helpTitle": "env-landscape-info",
    "properties": {
      "ModelFileName": {
        "description": "オブジェクトの *.x ファイルを指定します。",
        "helpUrl": "https://rs2.simochee.net/pi_sym_env_landscape_info.html",
  ...
  "Lighting": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_env_lighting.html",
    "helpTitle": "env-lighting",
    "properties": {
      "NightThreshold": {
  ...
  "Moon": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_env_moon_info.html",
    "helpTitle": "env-moon-info",
    "properties": {
      "ModelFileName": {
        "description": "オブジェクトの *.x ファイルを指定します。",
        "helpUrl": "https://rs2.simochee.net/pi_sym_env_moon_info.html",
  ...
  "Sun": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_env_sun_info.html",
    "helpTitle": "env-sun-info",
    "properties": {
      "ModelFileName": {
        "description": "オブジェクトの *.x ファイルを指定します。",
        "helpUrl": "https://rs2.simochee.net/pi_sym_env_sun_info.html",
  ...
  "Headlight": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_headlight_applier.html",
    "helpTitle": "headlight-applier",
    "properties": {
      "AttachObject": {
  ...
  "Interval": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_interval.html",
    "helpTitle": "interval",
    "properties": {
      "IgnoreCant": {
  ...
  "LensFlare": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_lens_flare.html",
    "helpTitle": "lens-flare",
    "properties": {
      "StartAngle": {
  ...
  "Set": {
    "description": "ライティング設定の単位要素です。",
    "helpUrl": "https://rs2.simochee.net/pi_sym_light_setting.html",
    "helpTitle": "light-setting",
    "properties": {
      "SunAlt": {
  ...
  "ChangeMaterial": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_material_changer.html",
    "helpTitle": "material-changer",
    "properties": {
      "MaterialID": {
  ...
  "DefineSwitch": {
    "description": "プラグインの外観設定などに利用できる選択肢を定義します。",
    "helpUrl": "https://rs2.simochee.net/pi_sym_model_switch.html",
    "helpTitle": "model-switch",
    "properties": {
      "DefineSwitch": {
  ...
  "Object3D": {
    "description": "モデルプラグイン全般において、オブジェクトを配置するのに使用される汎用フィールドです。",
    "helpUrl": "https://rs2.simochee.net/pi_sym_object_3d.html",
    "helpTitle": "object-3d",
    "properties": {
      "Object3D": {
        "description": "直後にオブジェクト名を書きます。このオブジェクト名は、他のオブジェクトがこのオブジェクトを親として参照する場合に使用されます。",
  ...
  "Joint3D": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_object_joint_3d.html",
    "helpTitle": "object-joint-3d",
    "properties": {
      "JointZY": {
  ...
  "JointZY": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_object_joint_zy.html",
    "helpTitle": "object-joint-zy",
    "properties": {
      "JointZY": {
  ...
  "JointZYX": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_object_joint_zyx.html",
    "helpTitle": "object-joint-zyx",
    "properties": {
      "JointZY": {
        "description": "直後に固定先のオブジェクト名を指定します。オブジェクト名は axle-object や body-object 等で定義されたものです。",
        "helpUrl": "https://rs2.simochee.net/pi_sym_object_joint_zyx.html",
  ...
  "ObjectZY": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_object_zy.html",
    "helpTitle": "object-zy",
    "properties": {
      "ObjectZY": {
        "description": "直後にオブジェクト名を書きます。このオブジェクト名は、他のオブジェクトがこのオブジェクトを親として参照する場合に使用されます。",
  ...
  "Particle": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_particle_applier.html",
    "helpTitle": "particle-applier",
    "properties": {
      "TextureFileName": {
  ...
  "Base": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_pier_base_info.html",
    "helpTitle": "pier-base-info",
    "properties": {
      "ModelFileName": {
        "description": "使用する *.x ファイルを指定します。",
        "helpUrl": "https://rs2.simochee.net/pi_sym_pier_base_info.html",
  ...
  "Head": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_pier_head_info.html",
    "helpTitle": "pier-head-info",
    "properties": {
      "ModelFileName": {
        "description": "使用する *.x ファイルを指定します。",
        "helpUrl": "https://rs2.simochee.net/pi_sym_pier_head_info.html",
  ...
  "Joint": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_pier_joint_info.html",
    "helpTitle": "pier-joint-info",
    "properties": {
      "ModelFileName": {
        "description": "使用する *.x ファイルを指定します。",
        "helpUrl": "https://rs2.simochee.net/pi_sym_pier_joint_info.html",
  ...
  "Platform": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_platform.html",
    "helpTitle": "platform",
    "properties": {
      "TrackNum": {
  ...
  "PluginHeader": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_plugin_header.html",
    "helpTitle": "plugin-header",
    "properties": {
      "RailSimVersion": {
  ...
  "Material": {
    "description": "プロファイルプラグインの断面定義です。",
    "helpUrl": "https://rs2.simochee.net/pi_sym_profile.html",
    "helpTitle": "profile",
    "properties": {
      "UseTexture": {
  ...
  "Vertex:Profile": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_profile_vertex.html",
    "helpTitle": "profile-vertex",
    "properties": {
      "IgnoreCant": {
  ...
  "PrimaryAssembly": {
    "description": "駅舎プラグインにおいて 2 本のプラットフォームのレールを接続します。分岐を作成することも可能です。",
    "helpUrl": "https://rs2.simochee.net/pi_sym_rail_brancher.html",
    "helpTitle": "rail-brancher",
    "properties": {
      "BranchRail": {
      ...
      "ConnectRail": {
        ...
        "helpUrl": "https://rs2.simochee.net/pi_sym_rail_connector.html",
        "helpTitle": "rail-connector"
      },
      "DisconnectRail": {
        "description": "接続を解除するプラットフォーム端点の番号を 1 個指定します。端点の番号は rail-connector の場合と同様に指定します。",
        "helpUrl": "https://rs2.simochee.net/pi_sym_rail_disconnector.html",
        "helpTitle": "rail-disconnector"
      }
    }
  },
  "Background": {
    "description": "スキンの画面背景に関する定義です。",
    "helpUrl": "https://rs2.simochee.net/pi_sym_skin_background_info.html",
    "helpTitle": "skin-background-info",
    "properties": {
      "UseWallpaper": {
  ...
  "EditCtrl": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_skin_editctrl_info.html",
    "helpTitle": "skin-editctrl-info",
    "properties": {
      "DefaultFontColor": {
  ...
  "Frame": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_skin_frame_info.html",
    "helpTitle": "skin-frame-info",
    "properties": {
      "FrameTexFileName": {
  ...
  "Interface": {
    "description": "スキンのインターフェイス全般に関する定義です。",
    "helpUrl": "https://rs2.simochee.net/pi_sym_skin_interface_info.html",
    "helpTitle": "skin-interface-info",
    "properties": {
      "TexFileName": {
  ...
  "ListView": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_skin_listview_info.html",
    "helpTitle": "skin-listview-info",
    "properties": {
      "DefaultBaseColorOdd": {
  ...
  "Model": {
    "description": "スキンの各種モデルに関する定義です。",
    "helpUrl": "https://rs2.simochee.net/pi_sym_skin_model_info.html",
    "helpTitle": "skin-model-info",
    "properties": {
      "ArrowModelFileName": {
  ...
  "PluginTree": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_skin_plugintree_info.html",
    "helpTitle": "skin-plugintree-info",
    "properties": {
      "DefaultBaseColor": {
  ...
  "PopupMenu": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_skin_popupmenu_info.html",
    "helpTitle": "skin-popupmenu-info",
    "properties": {
      "DefaultFontColor": {
  ...
  "Sound": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_skin_sound_info.html",
    "helpTitle": "skin-sound-info",
    "properties": {
  ...
  "SoundEffect": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_sound_effector.html",
    "helpTitle": "sound-effector",
    "properties": {
      "WaveFileName": {
  ...
  "StaticMove": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_static_mover.html",
    "helpTitle": "static-mover",
    "properties": {
      "Displacement": {
      ...
      "PreAnimationDelay": {
        ...
        "helpUrl": "https://rs2.simochee.net/pi_sym_static_timing_info.html",
        "helpTitle": "static-timing-info"
      },
      "AnimationTime": {
  ...
  "StaticRotation": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_static_rotator.html",
    "helpTitle": "static-rotator",
    "properties": {
      "RotationAxis": {
        "description": "回転軸をオブジェクトのローカル座標系で指定します。デフォルト値は Z 軸になります。",
        "helpUrl": "https://rs2.simochee.net/pi_sym_static_rotator.html",
  ...
  "Link": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_triangle_link_zy.html",
    "helpTitle": "triangle-link-zy",
    "properties": {
      "Link": {
        "description": "直後にオブジェクト名を書きます。このオブジェクト名は、他のオブジェクトがこのオブジェクトを親として参照する場合に使用されます。",
        "helpUrl": "https://rs2.simochee.net/pi_sym_triangle_link_zy.html",
  ...
  "Whiteout": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_whiteout.html",
    "helpTitle": "whiteout",
    "properties": {
      "StartAngle": {
  ...
  "TrackWind": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_wind_tracker.html",
    "helpTitle": "wind-tracker",
    "properties": {
      "TrackSpeed": {
  ...
  "Windmill": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_windmill.html",
    "helpTitle": "windmill",
    "properties": {
      "Directional": {
  ...
  "Wireframe": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_wireframe.html",
    "helpTitle": "wireframe",
    "properties": {
      "MinInterval": {
  ...
  "Vertex:Wireframe": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_wireframe_vertex.html",
    "helpTitle": "wireframe-vertex",
    "properties": {
      "IgnoreCant": {
        "description": "カントの影響を無視するかどうか指定します。バラストの底辺など、カントの影響を無視すべき頂点で yes を指定します。デフォルト値は no です。",
        "helpUrl": "https://rs2.simochee.net/pi_sym_wireframe_vertex.html",
  ...
  "NormalCursor": {
    ...
    "helpUrl": "https://rs2.simochee.net/pi_sym_cursor_info.html",
    "helpTitle": "cursor-info",
    "properties": {
      "TexFileName": {
      ...
      "NormalCursor": {
        ...
        "helpUrl": "https://rs2.simochee.net/pi_sym_skin_cursor_info.html",
        "helpTitle": "skin-cursor-info"
      },
      "ResizeCursor1": {
