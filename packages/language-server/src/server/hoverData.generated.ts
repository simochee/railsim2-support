...
export const objectDocs: Record<string, ObjectDoc> = {
  ...
  "Axle": {
    ...
    "properties": {
      ...
      "AlphaZeroTest": {
        ...
        "helpUrl": "https://railsim2.simochee.net/pi_sym_alpha_tester.html",
      ...
      "EnvMap": {
        ...
        "helpUrl": "https://railsim2.simochee.net/pi_sym_env_mapper.html",
      ...
      "NoCastShadow": {
        ...
        "helpUrl": "https://railsim2.simochee.net/pi_sym_shadow_inhibitor.html",
      ...
      "ChangeTexture": {
        ...
        "helpUrl": "https://railsim2.simochee.net/pi_sym_texture_changer.html",
        "helpTitle": "texture-changer"
      },
      "ScaleTexture": {
        "description": "UV 座標をスケーリングした後で平行移動します。材質番号に続けて、u, v 方向の倍率、移動する u, v 値の順に指定します。",
        "helpUrl": "https://railsim2.simochee.net/pi_sym_texture_transformer.html",
  ...
  "Set": {
    ...
    "helpUrl": "https://railsim2.simochee.net/pi_sym_light_setting.html",
  ...
  "DefineSwitch": {
    ...
    "helpUrl": "https://railsim2.simochee.net/pi_sym_model_switch.html",
  ...
  "Object3D": {
    ...
    "helpUrl": "https://railsim2.simochee.net/pi_sym_object_3d.html",
    "helpTitle": "object-3d",
    "properties": {
      "Object3D": {
        "description": "直後にオブジェクト名を書きます。このオブジェクト名は、他のオブジェクトがこのオブジェクトを親として参照する場合に使用されます。",
  ...
  "Material": {
    ...
    "helpUrl": "https://railsim2.simochee.net/pi_sym_profile.html",
    "helpTitle": "profile",
    "properties": {
      "UseTexture": {
  ...
  "PrimaryAssembly": {
    ...
    "helpUrl": "https://railsim2.simochee.net/pi_sym_rail_brancher.html",
    ...
    "properties": {
      ...
      "ConnectRail": {
        ...
        "helpUrl": "https://railsim2.simochee.net/pi_sym_rail_connector.html",
        "helpTitle": "rail-connector"
      },
      "DisconnectRail": {
        "description": "接続を解除するプラットフォーム端点の番号を 1 個指定します。端点の番号は rail-connector の場合と同様に指定します。",
        "helpUrl": "https://railsim2.simochee.net/pi_sym_rail_disconnector.html",
  ...
  "Interface": {
    ...
    "helpUrl": "https://railsim2.simochee.net/pi_sym_skin_interface_info.html",
  ...
  "Model": {
    ...
    "helpUrl": "https://railsim2.simochee.net/pi_sym_skin_model_info.html",
  ...
  "StaticMove": {
    ...
    "properties": {
      ...
      "PreAnimationDelay": {
        ...
        "helpUrl": "https://railsim2.simochee.net/pi_sym_static_timing_info.html",
  ...
  "NormalCursor": {
    ...
    "properties": {
      ...
      "NormalCursor": {
        ...
        "helpUrl": "https://railsim2.simochee.net/pi_sym_skin_cursor_info.html",
